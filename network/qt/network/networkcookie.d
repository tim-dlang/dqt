...
/// Binding for C++ class [QNetworkCookie](https://doc.qt.io/qt-5/qnetworkcookie.html).
@Q_DECLARE_METATYPE @Q_MOVABLE_TYPE extern(C++, class) struct /+ Q_NETWORK_EXPORT +/ QNetworkCookie
{
public:
    enum RawForm {
        NameAndValueOnly,
