...
extern(C++, "QTest")
{
                                 ...
                                 QString text, /+ Qt:: +/qt.core.namespace.KeyboardModifiers modifier, int delay=-1)
    {
        ...
        if (action == KeyAction.Press) {
            if (modifier & /+ Qt:: +/qt.core.namespace.KeyboardModifier.ShiftModifier)
                simulateEvent(window, true, /+ Qt:: +/qt.core.namespace.Key.Key_Shift, /+ Qt:: +/qt.core.namespace.KeyboardModifiers(), QString.create(), false, delay);

            if (modifier & /+ Qt:: +/qt.core.namespace.KeyboardModifier.ControlModifier)
                simulateEvent(window, true, /+ Qt:: +/qt.core.namespace.Key.Key_Control, modifier & /+ Qt:: +/qt.core.namespace.KeyboardModifier.ShiftModifier, QString.create(), false, delay);

            if (modifier & /+ Qt:: +/qt.core.namespace.KeyboardModifier.AltModifier)
                simulateEvent(window, true, /+ Qt:: +/qt.core.namespace.Key.Key_Alt,
                              modifier & (/+ Qt:: +/qt.core.namespace.KeyboardModifier.ShiftModifier | /+ Qt:: +/qt.core.namespace.KeyboardModifier.ControlModifier), QString.create(), false, delay);
            if (modifier & /+ Qt:: +/qt.core.namespace.KeyboardModifier.MetaModifier)
                simulateEvent(window, true, /+ Qt:: +/qt.core.namespace.Key.Key_Meta, modifier & (/+ Qt:: +/qt.core.namespace.KeyboardModifier.ShiftModifier
                                                                      | /+ Qt:: +/qt.core.namespace.KeyboardModifier.ControlModifier | /+ Qt:: +/qt.core.namespace.KeyboardModifier.AltModifier), QString.create(), false, delay);
            ...
            if (modifier & /+ Qt:: +/qt.core.namespace.KeyboardModifier.MetaModifier)
                simulateEvent(window, false, /+ Qt:: +/qt.core.namespace.Key.Key_Meta, modifier, QString.create(), false, delay);
            if (modifier & /+ Qt:: +/qt.core.namespace.KeyboardModifier.AltModifier)
                simulateEvent(window, false, /+ Qt:: +/qt.core.namespace.Key.Key_Alt, modifier &
                              (/+ Qt:: +/qt.core.namespace.KeyboardModifier.ShiftModifier | /+ Qt:: +/qt.core.namespace.KeyboardModifier.ControlModifier | /+ Qt:: +/qt.core.namespace.KeyboardModifier.AltModifier), QString.create(), false, delay);
            ...
            if (modifier & /+ Qt:: +/qt.core.namespace.KeyboardModifier.ShiftModifier)
                simulateEvent(window, false, /+ Qt:: +/qt.core.namespace.Key.Key_Shift, modifier & /+ Qt:: +/qt.core.namespace.KeyboardModifier.ShiftModifier, QString.create(), false, delay);
        }
    }
    ...
    /+ Q_DECL_UNUSED +/ pragma(inline, true) void keyClick(QWindow window, /+ Qt:: +/qt.core.namespace.Key key, /+ Qt:: +/qt.core.namespace.KeyboardModifiers modifier = /+ Qt:: +/qt.core.namespace.KeyboardModifier.NoModifier, int delay=-1)
    { keyEvent(KeyAction.Click, window, key, modifier, delay); }
    /+ Q_DECL_UNUSED +/ pragma(inline, true) void keyClick(QWindow window, char key, /+ Qt:: +/qt.core.namespace.KeyboardModifiers modifier = /+ Qt:: +/qt.core.namespace.KeyboardModifier.NoModifier, int delay=-1)
    { keyEvent(KeyAction.Click, window, key, modifier, delay); }
    /+ Q_DECL_UNUSED +/ pragma(inline, true) void keyRelease(QWindow window, char key, /+ Qt:: +/qt.core.namespace.KeyboardModifiers modifier = /+ Qt:: +/qt.core.namespace.KeyboardModifier.NoModifier, int delay=-1)
    { keyEvent(KeyAction.Release, window, key, modifier, delay); }
    /+ Q_DECL_UNUSED +/ pragma(inline, true) void keyRelease(QWindow window, /+ Qt:: +/qt.core.namespace.Key key, /+ Qt:: +/qt.core.namespace.KeyboardModifiers modifier = /+ Qt:: +/qt.core.namespace.KeyboardModifier.NoModifier, int delay=-1)
    { keyEvent(KeyAction.Release, window, key, modifier, delay); }
    /+ Q_DECL_UNUSED +/ pragma(inline, true) void keyPress(QWindow window, char key, /+ Qt:: +/qt.core.namespace.KeyboardModifiers modifier = /+ Qt:: +/qt.core.namespace.KeyboardModifier.NoModifier, int delay=-1)
    { keyEvent(KeyAction.Press, window, key, modifier, delay); }
    /+ Q_DECL_UNUSED +/ pragma(inline, true) void keyPress(QWindow window, /+ Qt:: +/qt.core.namespace.Key key, /+ Qt:: +/qt.core.namespace.KeyboardModifiers modifier = /+ Qt:: +/qt.core.namespace.KeyboardModifier.NoModifier, int delay=-1)
    { keyEvent(KeyAction.Press, window, key, modifier, delay); }

/+ #if QT_CONFIG(shortcut) +/
    /+ Q_DECL_UNUSED +/ pragma(inline, true) void keySequence(QWindow window, ref const(QKeySequence) keySequence__1)
    {
        for (int i = 0; i < keySequence__1.count(); ++i) {
            const(/+ Qt:: +/qt.core.namespace.Key) key = /+ Qt:: +/qt.core.namespace.Key(cast(qt.core.namespace.Key) (keySequence__1[i] & ~/+ Qt:: +/qt.core.namespace.KeyboardModifier.KeyboardModifierMask));
            const(/+ Qt:: +/qt.core.namespace.KeyboardModifiers) modifiers = /+ Qt:: +/qt.core.namespace.KeyboardModifiers(cast(qt.core.namespace.KeyboardModifier) (keySequence__1[i] & /+ Qt:: +/qt.core.namespace.KeyboardModifier.KeyboardModifierMask));
...
/+ #endif
                                  ...
                                  /+ Qt:: +/qt.core.namespace.KeyboardModifiers modifier, QString text, bool repeat, int delay=-1)
    {
        ...
        if (press && qt_sendShortcutOverrideEvent(widget, a.timestamp(), code, modifier, text, repeat))
            return;
        if (! mixin(qt.gui.guiapplication.qApp).notify(widget, &a))
            /+ QTest:: +/qt.test.testcase.qWarn("Keyboard event not accepted by receiving widget");
    }
...
/+ #if QT_CONFIG(shortcut) +/
    ...
    {
        for (int i = 0; i < keySequence__1.count(); ++i) {
            const(/+ Qt:: +/qt.core.namespace.Key) key = /+ Qt:: +/qt.core.namespace.Key(keySequence__1[i] & ~/+ Qt:: +/qt.core.namespace.KeyboardModifier.KeyboardModifierMask);
            const(/+ Qt:: +/qt.core.namespace.KeyboardModifiers) modifiers = /+ Qt:: +/qt.core.namespace.KeyboardModifiers(keySequence__1[i] & /+ Qt:: +/qt.core.namespace.KeyboardModifier.KeyboardModifierMask);
