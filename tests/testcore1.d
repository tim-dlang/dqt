...
unittest
{
    ...
    assert(method.name().toConstCharArray() == "emitSignalVoid");
    assert(method.methodSignature().toConstCharArray() == "emitSignalVoid()");
    assert(method.parameterCount() == 0);
    assert(method.methodType() == QMetaMethod.MethodType.Method);

    method = mo.method(mo.indexOfMethod("onSignalVoid()"));
    assert(method.name().toConstCharArray() == "onSignalVoid");
    assert(method.methodSignature().toConstCharArray() == "onSignalVoid()");
    assert(method.parameterCount() == 0);
