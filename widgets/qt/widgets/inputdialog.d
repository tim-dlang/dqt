...
/// Binding for C++ class [QInputDialog](https://doc.qt.io/qt-6/qinputdialog.html).
...
alias InputDialogOptions = QFlags!(InputDialogOption);
    ...
    static double getDouble(QWidget parent, ref const(QString) title, ref const(QString) label, double value = 0,
                                double minValue = -2147483647, double maxValue = 2147483647,
                                int decimals = 1, bool* ok = null, /+ Qt:: +/qt.core.namespace.WindowFlags flags = /+ Qt:: +/qt.core.namespace.WindowFlags(),
                                double step = 1);
...
/+pragma(inline, true) QFlags!(QInputDialog.InputDialogOptions.enum_type) operator |(QInputDialog.InputDialogOptions.enum_type f1, QInputDialog.InputDialogOptions.enum_type f2)nothrow{return QFlags!(QInputDialog.InputDialogOptions.enum_type)(f1)|f2;}+/
/+pragma(inline, true) QFlags!(QInputDialog.InputDialogOptions.enum_type) operator |(QInputDialog.InputDialogOptions.enum_type f1, QFlags!(QInputDialog.InputDialogOptions.enum_type) f2)nothrow{return f2|f1;}+/
/+pragma(inline, true) QFlags!(QInputDialog.InputDialogOptions.enum_type) operator &(QInputDialog.InputDialogOptions.enum_type f1, QInputDialog.InputDialogOptions.enum_type f2)nothrow{return QFlags!(QInputDialog.InputDialogOptions.enum_type)(f1)&f2;}+/
/+pragma(inline, true) QFlags!(QInputDialog.InputDialogOptions.enum_type) operator &(QInputDialog.InputDialogOptions.enum_type f1, QFlags!(QInputDialog.InputDialogOptions.enum_type) f2)nothrow{return f2&f1;}+/
/+pragma(inline, true) QFlags!(QInputDialog.InputDialogOptions.enum_type) operator ^(QInputDialog.InputDialogOptions.enum_type f1, QInputDialog.InputDialogOptions.enum_type f2)nothrow{return QFlags!(QInputDialog.InputDialogOptions.enum_type)(f1)^f2;}+/
/+pragma(inline, true) QFlags!(QInputDialog.InputDialogOptions.enum_type) operator ^(QInputDialog.InputDialogOptions.enum_type f1, QFlags!(QInputDialog.InputDialogOptions.enum_type) f2)nothrow{return f2^f1;}+/
/+pragma(inline, true) void operator +(QInputDialog.InputDialogOptions.enum_type f1, QInputDialog.InputDialogOptions.enum_type f2)nothrow;+/
/+pragma(inline, true) void operator +(QInputDialog.InputDialogOptions.enum_type f1, QFlags!(QInputDialog.InputDialogOptions.enum_type) f2)nothrow;+/
/+pragma(inline, true) void operator +(int f1, QFlags!(QInputDialog.InputDialogOptions.enum_type) f2)nothrow;+/
/+pragma(inline, true) void operator -(QInputDialog.InputDialogOptions.enum_type f1, QInputDialog.InputDialogOptions.enum_type f2)nothrow;+/
/+pragma(inline, true) void operator -(QInputDialog.InputDialogOptions.enum_type f1, QFlags!(QInputDialog.InputDialogOptions.enum_type) f2)nothrow;+/
/+pragma(inline, true) void operator -(int f1, QFlags!(QInputDialog.InputDialogOptions.enum_type) f2)nothrow;+/
/+pragma(inline, true) void operator +(int f1, QInputDialog.InputDialogOptions.enum_type f2)nothrow;+/
/+pragma(inline, true) void operator +(QInputDialog.InputDialogOptions.enum_type f1, int f2)nothrow;+/
/+pragma(inline, true) void operator -(int f1, QInputDialog.InputDialogOptions.enum_type f2)nothrow;+/
/+pragma(inline, true) void operator -(QInputDialog.InputDialogOptions.enum_type f1, int f2)nothrow;+/
static if (defined!"QT_TYPESAFE_FLAGS")
{
/+pragma(inline, true) QInputDialog.InputDialogOptions operator ~(QInputDialog.InputDialogOptions.enum_type e)nothrow{return~QInputDialog.InputDialogOptions(e);}+/
/+pragma(inline, true) void operator |(QInputDialog.InputDialogOptions.enum_type f1, int f2)nothrow;+/
}
static if (!defined!"QT_TYPESAFE_FLAGS")
{
/+pragma(inline, true) QIncompatibleFlag operator |(QInputDialog.InputDialogOptions.enum_type f1, int f2)nothrow{return QIncompatibleFlag(int(f1)|f2);}+/
}
