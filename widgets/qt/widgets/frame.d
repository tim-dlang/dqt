...
/+pragma(inline, true) int operator |(QFrame.Shape lhs, QFrame.Shadow rhs)nothrow{return static_cast!(int)(qToUnderlying(lhs)|qToUnderlying(rhs));}+/
/+pragma(inline, true) int operator &(QFrame.Shape lhs, QFrame.Shadow rhs)nothrow{return static_cast!(int)(qToUnderlying(lhs)&qToUnderlying(rhs));}+/
/+pragma(inline, true) int operator ^(QFrame.Shape lhs, QFrame.Shadow rhs)nothrow{return static_cast!(int)(qToUnderlying(lhs)^qToUnderlying(rhs));}+/
/+pragma(inline, true) int operator |(QFrame.Shadow lhs, QFrame.Shape rhs)nothrow{return static_cast!(int)(qToUnderlying(lhs)|qToUnderlying(rhs));}+/
/+pragma(inline, true) int operator &(QFrame.Shadow lhs, QFrame.Shape rhs)nothrow{return static_cast!(int)(qToUnderlying(lhs)&qToUnderlying(rhs));}+/
/+pragma(inline, true) int operator ^(QFrame.Shadow lhs, QFrame.Shape rhs)nothrow{return static_cast!(int)(qToUnderlying(lhs)^qToUnderlying(rhs));}+/
