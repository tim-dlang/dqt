...
/+pragma(inline, true) QFlags!(QDialogButtonBox.StandardButtons.enum_type) operator ^(QDialogButtonBox.StandardButtons.enum_type f1, QDialogButtonBox.StandardButtons.enum_type f2)nothrow{return QFlags!(QDialogButtonBox.StandardButtons.enum_type)(f1)^f2;}+/
/+pragma(inline, true) QFlags!(QDialogButtonBox.StandardButtons.enum_type) operator ^(QDialogButtonBox.StandardButtons.enum_type f1, QFlags!(QDialogButtonBox.StandardButtons.enum_type) f2)nothrow{return f2^f1;}+/
/+pragma(inline, true) void operator +(QDialogButtonBox.StandardButtons.enum_type f1, QDialogButtonBox.StandardButtons.enum_type f2)nothrow;+/
/+pragma(inline, true) void operator +(QDialogButtonBox.StandardButtons.enum_type f1, QFlags!(QDialogButtonBox.StandardButtons.enum_type) f2)nothrow;+/
/+pragma(inline, true) void operator +(int f1, QFlags!(QDialogButtonBox.StandardButtons.enum_type) f2)nothrow;+/
/+pragma(inline, true) void operator -(QDialogButtonBox.StandardButtons.enum_type f1, QDialogButtonBox.StandardButtons.enum_type f2)nothrow;+/
/+pragma(inline, true) void operator -(QDialogButtonBox.StandardButtons.enum_type f1, QFlags!(QDialogButtonBox.StandardButtons.enum_type) f2)nothrow;+/
/+pragma(inline, true) void operator -(int f1, QFlags!(QDialogButtonBox.StandardButtons.enum_type) f2)nothrow;+/
/+pragma(inline, true) void operator +(int f1, QDialogButtonBox.StandardButtons.enum_type f2)nothrow;+/
/+pragma(inline, true) void operator +(QDialogButtonBox.StandardButtons.enum_type f1, int f2)nothrow;+/
/+pragma(inline, true) void operator -(int f1, QDialogButtonBox.StandardButtons.enum_type f2)nothrow;+/
/+pragma(inline, true) void operator -(QDialogButtonBox.StandardButtons.enum_type f1, int f2)nothrow;+/
static if (defined!"QT_TYPESAFE_FLAGS")
{
/+pragma(inline, true) QDialogButtonBox.StandardButtons operator ~(QDialogButtonBox.StandardButtons.enum_type e)nothrow{return~QDialogButtonBox.StandardButtons(e);}+/
/+pragma(inline, true) void operator |(QDialogButtonBox.StandardButtons.enum_type f1, int f2)nothrow;+/
}
static if (!defined!"QT_TYPESAFE_FLAGS")
{
