...
/+pragma(inline, true) QFlags!(QFileDialog.Options.enum_type) operator |(QFileDialog.Options.enum_type f1, QFileDialog.Options.enum_type f2)nothrow{return QFlags!(QFileDialog.Options.enum_type)(f1)|f2;}+/
/+pragma(inline, true) QFlags!(QFileDialog.Options.enum_type) operator |(QFileDialog.Options.enum_type f1, QFlags!(QFileDialog.Options.enum_type) f2)nothrow{return f2|f1;}+/
/+pragma(inline, true) QFlags!(QFileDialog.Options.enum_type) operator &(QFileDialog.Options.enum_type f1, QFileDialog.Options.enum_type f2)nothrow{return QFlags!(QFileDialog.Options.enum_type)(f1)&f2;}+/
/+pragma(inline, true) QFlags!(QFileDialog.Options.enum_type) operator &(QFileDialog.Options.enum_type f1, QFlags!(QFileDialog.Options.enum_type) f2)nothrow{return f2&f1;}+/
/+pragma(inline, true) QFlags!(QFileDialog.Options.enum_type) operator ^(QFileDialog.Options.enum_type f1, QFileDialog.Options.enum_type f2)nothrow{return QFlags!(QFileDialog.Options.enum_type)(f1)^f2;}+/
/+pragma(inline, true) QFlags!(QFileDialog.Options.enum_type) operator ^(QFileDialog.Options.enum_type f1, QFlags!(QFileDialog.Options.enum_type) f2)nothrow{return f2^f1;}+/
/+pragma(inline, true) void operator +(QFileDialog.Options.enum_type f1, QFileDialog.Options.enum_type f2)nothrow;+/
/+pragma(inline, true) void operator +(QFileDialog.Options.enum_type f1, QFlags!(QFileDialog.Options.enum_type) f2)nothrow;+/
/+pragma(inline, true) void operator +(int f1, QFlags!(QFileDialog.Options.enum_type) f2)nothrow;+/
/+pragma(inline, true) void operator -(QFileDialog.Options.enum_type f1, QFileDialog.Options.enum_type f2)nothrow;+/
/+pragma(inline, true) void operator -(QFileDialog.Options.enum_type f1, QFlags!(QFileDialog.Options.enum_type) f2)nothrow;+/
/+pragma(inline, true) void operator -(int f1, QFlags!(QFileDialog.Options.enum_type) f2)nothrow;+/
/+pragma(inline, true) void operator +(int f1, QFileDialog.Options.enum_type f2)nothrow;+/
/+pragma(inline, true) void operator +(QFileDialog.Options.enum_type f1, int f2)nothrow;+/
/+pragma(inline, true) void operator -(int f1, QFileDialog.Options.enum_type f2)nothrow;+/
/+pragma(inline, true) void operator -(QFileDialog.Options.enum_type f1, int f2)nothrow;+/
static if (defined!"QT_TYPESAFE_FLAGS")
{
/+pragma(inline, true) QFileDialog.Options operator ~(QFileDialog.Options.enum_type e)nothrow{return~QFileDialog.Options(e);}+/
/+pragma(inline, true) void operator |(QFileDialog.Options.enum_type f1, int f2)nothrow;+/
}
static if (!defined!"QT_TYPESAFE_FLAGS")
{
/+pragma(inline, true) QIncompatibleFlag operator |(QFileDialog.Options.enum_type f1, int f2)nothrow{return QIncompatibleFlag(int(f1)|f2);}+/
}
