...
/+pragma(inline, true) QFlags!(QWebEngineUrlScheme.Flags.enum_type) operator ^(QWebEngineUrlScheme.Flags.enum_type f1, QWebEngineUrlScheme.Flags.enum_type f2)nothrow{return QFlags!(QWebEngineUrlScheme.Flags.enum_type)(f1)^f2;}+/
/+pragma(inline, true) QFlags!(QWebEngineUrlScheme.Flags.enum_type) operator ^(QWebEngineUrlScheme.Flags.enum_type f1, QFlags!(QWebEngineUrlScheme.Flags.enum_type) f2)nothrow{return f2^f1;}+/
/+pragma(inline, true) void operator +(QWebEngineUrlScheme.Flags.enum_type f1, QWebEngineUrlScheme.Flags.enum_type f2)nothrow;+/
/+pragma(inline, true) void operator +(QWebEngineUrlScheme.Flags.enum_type f1, QFlags!(QWebEngineUrlScheme.Flags.enum_type) f2)nothrow;+/
/+pragma(inline, true) void operator +(int f1, QFlags!(QWebEngineUrlScheme.Flags.enum_type) f2)nothrow;+/
/+pragma(inline, true) void operator -(QWebEngineUrlScheme.Flags.enum_type f1, QWebEngineUrlScheme.Flags.enum_type f2)nothrow;+/
/+pragma(inline, true) void operator -(QWebEngineUrlScheme.Flags.enum_type f1, QFlags!(QWebEngineUrlScheme.Flags.enum_type) f2)nothrow;+/
/+pragma(inline, true) void operator -(int f1, QFlags!(QWebEngineUrlScheme.Flags.enum_type) f2)nothrow;+/
/+pragma(inline, true) void operator +(int f1, QWebEngineUrlScheme.Flags.enum_type f2)nothrow;+/
/+pragma(inline, true) void operator +(QWebEngineUrlScheme.Flags.enum_type f1, int f2)nothrow;+/
/+pragma(inline, true) void operator -(int f1, QWebEngineUrlScheme.Flags.enum_type f2)nothrow;+/
/+pragma(inline, true) void operator -(QWebEngineUrlScheme.Flags.enum_type f1, int f2)nothrow;+/
static if (defined!"QT_TYPESAFE_FLAGS")
{
/+pragma(inline, true) QWebEngineUrlScheme.Flags operator ~(QWebEngineUrlScheme.Flags.enum_type e)nothrow{return~QWebEngineUrlScheme.Flags(e);}+/
/+pragma(inline, true) void operator |(QWebEngineUrlScheme.Flags.enum_type f1, int f2)nothrow;+/
}
static if (!defined!"QT_TYPESAFE_FLAGS")
{
