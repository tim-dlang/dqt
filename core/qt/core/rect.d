...
public:
    ...
    { return y2; }
    /+ [[nodiscard]] +/ QRect normalized() const nothrow;
    ...
    /+ [[nodiscard]] +/ pragma(inline, true) QRect translated(int dx, int dy) const nothrow
    { auto tmp = QPoint(x1 + dx, y1 + dy); auto tmp__1 = QPoint(x2 + dx, y2 + dy); return QRect(tmp, tmp__1); }
    /+ [[nodiscard]] +/ pragma(inline, true) QRect translated(ref const(QPoint) p) const nothrow
    { auto tmp = QPoint(x1 + p.x(), y1 + p.y()); auto tmp__1 = QPoint(x2 + p.x(), y2 + p.y()); return QRect(tmp, tmp__1); }
    /+ [[nodiscard]] +/ pragma(inline, true) QRect transposed() const nothrow
    ...
    /+ [[nodiscard]] +/ pragma(inline, true) QRect adjusted(int xp1, int yp1, int xp2, int yp2) const nothrow
    ...
    /+ [[nodiscard]] +/ pragma(inline, true) QRect united(ref const(QRect) r) const nothrow
    {
        return this | r;
    }
    /+ [[nodiscard]] +/ pragma(inline, true) QRect intersected(ref const(QRect) other) const nothrow
    {
        return this & other;
    }
    ...
    /+ [[nodiscard]] +/ pragma(inline, true) QRectF toRectF() const nothrow { return QRectF(this); }
...
public:
    ...
    pragma(inline, true) bool isValid() const nothrow
    { return w > 0. && h > 0.; }
    /+ [[nodiscard]] +/ QRectF normalized() const nothrow;
    ...
    /+ [[nodiscard]] +/ pragma(inline, true) QRectF translated(qreal dx, qreal dy) const nothrow
    {
        return QRectF(xp + dx, yp + dy, w, h);
    }
    /+ [[nodiscard]] +/ pragma(inline, true) QRectF translated(ref const(QPointF) p) const nothrow
    { return QRectF(xp + p.x(), yp + p.y(), w, h); }

    /+ [[nodiscard]] +/ pragma(inline, true) QRectF transposed() const nothrow
    ...
    /+ [[nodiscard]] +/ pragma(inline, true) QRectF adjusted(qreal xp1, qreal yp1, qreal xp2, qreal yp2) const nothrow
    {
    ...
    /+ [[nodiscard]] +/ pragma(inline, true) QRectF united(ref const(QRectF) r) const nothrow
    {
        return this | r;
    }
    /+ [[nodiscard]] +/ pragma(inline, true) QRectF intersected(ref const(QRectF) r) const nothrow
    {
        return this & r;
    }
    ...
    /+ [[nodiscard]] +/ pragma(inline, true) QRect toRect() const nothrow
    {
    ...
    /+ [[nodiscard]] +/ QRect toAlignedRect() const nothrow;
