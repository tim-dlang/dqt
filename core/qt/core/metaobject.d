...
/// Binding for C++ class [QMetaMethod](https://doc.qt.io/qt-6/qmetamethod.html).
@Q_RELOCATABLE_TYPE extern(C++, class) struct /+ Q_CORE_EXPORT +/ QMetaMethod
{
public:
    @disable this();
...
private:
    ...
    struct Data {
        ...
        /+bool operator ==(ref const(Data) other) const { return d == other.d; }+/

        const(uint)* d;
    }
    this(const(QMetaObject)* metaObject, ref const(Data) data_)
    {
        this.mobj = metaObject;
        this.data = data_;
    }
...
/// Binding for C++ class [QMetaEnum](https://doc.qt.io/qt-6/qmetaenum.html).
@Q_RELOCATABLE_TYPE extern(C++, class) struct /+ Q_CORE_EXPORT +/ QMetaEnum
{
public:
    @disable this();
    /+pragma(inline, true) this()
...
private:
    struct Data {
        ...
        quint32 alias_() const { return d[1]; }
    ...
    this(const(QMetaObject)* mobj, int index);
...
/// Binding for C++ class [QMetaProperty](https://doc.qt.io/qt-6/qmetaproperty.html).
...
/// Binding for C++ class [QMetaClassInfo](https://doc.qt.io/qt-6/qmetaclassinfo.html).
@Q_RELOCATABLE_TYPE extern(C++, class) struct /+ Q_CORE_EXPORT +/ QMetaClassInfo
{
public:
    @disable this();
    /+pragma(inline, true) this()
