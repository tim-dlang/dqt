...
/// Binding for C++ class [QThreadPool](https://doc.qt.io/qt-5/qthreadpool.html).
...
/+ #if QT_DEPRECATED_SINCE(5, 9) +/
    /+ QT_DEPRECATED_X("use tryTake(), but note the different deletion rules") +/
        final void cancel(QRunnable runnable);
/+ #endif +/
    /+ Q_REQUIRED_RESULT +/ final bool tryTake(QRunnable runnable);
