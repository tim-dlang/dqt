 ...
 */
module qt.multimedia.audioinput;
extern(C++):
...
extern(C++, class) struct QPlatformAudioInput;

/// Binding for C++ class [QAudioInput](https://doc.qt.io/qt-6/qaudioinput.html).
class /+ Q_MULTIMEDIA_EXPORT +/ QAudioInput : QObject
{
    mixin(Q_OBJECT);
...
public:
    ...
    /+ explicit +/this(ref const(QAudioDevice) deviceInfo, QObject parent = null);
    ~this();
