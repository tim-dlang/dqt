...
/// Binding for C++ class [QQuickItem](https://doc.qt.io/qt-5/qquickitem.html).
...
/+ #endif +/
    ...
    final void grabTouchPoints(ref const(QVector!(int)) ids);
    ...
    /+ Q_REVISION(4) +/ @QInvokable final bool grabToImage(ref const(QJSValue) callback, ref const(QSize) targetSize = globalInitVar!QSize);
    ...
    /+ Q_REVISION(7) +/ @QInvokable final void mapFromGlobal(QQmlV4Function*) const;
    /+ Q_REVISION(7) +/ @QInvokable final void mapToGlobal(QQmlV4Function*) const;
    @QInvokable final void forceActiveFocus();
    @QInvokable final void forceActiveFocus(/+ Qt:: +/qt.core.namespace.FocusReason reason);
    /+ Q_REVISION(1) +/ @QInvokable final QQuickItem nextItemInFocusChain(bool forward = true);
...
/+ Q_SIGNALS +/public:
    ...
    /+ Q_REVISION(1) +/ @QSignal final void activeFocusOnTabChanged(bool);
    ...
    /+ Q_REVISION(1) +/ @QSignal final void windowChanged(QQuickWindow* window);
    ...
    /+ Q_REVISION(11) +/ @QSignal final void containmentMaskChanged();
